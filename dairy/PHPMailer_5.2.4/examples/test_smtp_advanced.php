...
try {
  ...
  $mail->Password   = "sangalaxy";        // SMTP account password
  $mail->AddAddress('san.kumar19@gmail.com', 'John Doe');
  $mail->SetFrom('sanjeev.kumar@ehorizons.in', 'Sanjeev Kumar');
  $mail->AddReplyTo('sanjeev.kumar@ehorizons.in', 'Sanjeev Kumar');
